...
$old = $old ?? [];
?>
<h1 class="mb-4">Create Race</h1>

<form method="post" action="/admin/races" enctype="multipart/form-data" novalidate>
    <?= View::csrfField() ?>
    ...
    <div class="row g-3">
        ...
        <div class="col-12">
            ...
            <input type="file" id="photo" name="photo" class="form-control <?= isset($errors['photo']) ? 'is-invalid' : '' ?>"
                accept=".jpg,.jpeg,.png,.webp" aria-describedby="photo-error" required>
    ...
    <div class="mt-4 d-flex gap-2">
        ...
        <a href="/admin/races" class="btn btn-outline-secondary">Cancel</a>
    </div>
</form>
